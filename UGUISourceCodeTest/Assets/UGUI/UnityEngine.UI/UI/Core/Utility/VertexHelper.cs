...
namespace UnityEngine.UI
{
    ...
    public class VertexHelper : IDisposable
    {
        ...
        private List<Vector4> Tov4(List<Vector2> srcVec)
        {
            List<Vector4> res = new List<Vector4>();

            foreach (var vector2 in srcVec)
            {
                res.Add(new Vector4(vector2.x, vector2.y));
            }
        ...
        public void AddUIVertexStream(List<UIVertex> verts, List<int> indices)
        {
            ...
            if (verts != null)
            {
                CanvasRenderer.AddUIVertexStream(verts, m_Positions, m_Colors, Tov4(m_Uv0S), Tov4(m_Uv1S), Tov4(m_Uv2S), Tov4(m_Uv3S), m_Normals, m_Tangents);
            }
        ...
        public void AddUIVertexTriangleStream(List<UIVertex> verts)
        {
            ...
            CanvasRenderer.SplitUIVertexStreams(verts, m_Positions, m_Colors, Tov4(m_Uv0S), Tov4(m_Uv1S), Tov4(m_Uv2S), Tov4(m_Uv3S), m_Normals, m_Tangents, m_Indices);
        }
        ...
        public void GetUIVertexStream(List<UIVertex> stream)
        {
            ...
            CanvasRenderer.CreateUIVertexStream(stream, m_Positions, m_Colors, Tov4(m_Uv0S), Tov4(m_Uv1S), Tov4(m_Uv2S), Tov4(m_Uv3S), m_Normals, m_Tangents, m_Indices);
        }
    }
}
