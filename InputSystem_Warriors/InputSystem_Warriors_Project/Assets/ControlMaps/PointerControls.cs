...
namespace InputSamples.Controls
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""abv"",
            ""id"": ""fa8cdcd0-7bff-41bf-9605-7c85b6ec1f2f"",
            ""actions"": [
                {
                    ""name"": ""v"",
                    ""type"": ""Value"",
                    ""id"": ""8072f2bc-1fbe-4a97-9847-0f5efe498050"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
            ...
            ""bindings"": [
                {
                    ""name"": ""Pointer Input"",
                    ""id"": ""b1735215-08c8-4892-8b99-086340ad3f6d"",
                    ""path"": ""PointerInput"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""contact"",
                    ""id"": ""341afc63-983c-4922-acc6-d80a823034ce"",
                    ""path"": """",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""position"",
                    ""id"": ""0c3cfbd9-2a6d-43de-ac4c-8fad98368168"",
                    ""path"": """",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""tilt"",
                    ""id"": ""96160885-bc38-4ded-8a12-d26a69a694cc"",
                    ""path"": """",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""radius"",
                    ""id"": ""1e0145af-d64a-442f-9ddb-3c9df8645d7b"",
                    ""path"": """",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""pressure"",
                    ""id"": ""9084b26b-c2b0-41e0-83e2-1a5f6189a054"",
                    ""path"": """",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""twist"",
                    ""id"": ""250e1cd7-acd8-43aa-b0ea-b144539ccaa4"",
                    ""path"": """",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""inputId"",
                    ""id"": ""d962e849-b73a-4892-96c4-0a198d89cd7b"",
                    ""path"": """",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": [
        ...
        },
        {
            ...
            // abv
            m_abv = asset.FindActionMap("abv", throwIfNotFound: true);
            m_abv_v = m_abv.FindAction("v", throwIfNotFound: true);
        }
        ...
        ~@PointerControls()
        {
            ...
            UnityEngine.Debug.Assert(!m_abv.enabled, "This will cause a leak and performance issues, PointerControls.abv.Disable() has not been called.");
        }
        ...
        // abv
        private readonly InputActionMap m_abv;
        private List<IAbvActions> m_AbvActionsCallbackInterfaces = new List<IAbvActions>();
        private readonly InputAction m_abv_v;
        public struct AbvActions
        {
            private @PointerControls m_Wrapper;
            public AbvActions(@PointerControls wrapper) { m_Wrapper = wrapper; }
            public InputAction @v => m_Wrapper.m_abv_v;
            public InputActionMap Get() { return m_Wrapper.m_abv; }
            public void Enable() { Get().Enable(); }
            public void Disable() { Get().Disable(); }
            public bool enabled => Get().enabled;
            public static implicit operator InputActionMap(AbvActions set) { return set.Get(); }
            public void AddCallbacks(IAbvActions instance)
            {
                if (instance == null || m_Wrapper.m_AbvActionsCallbackInterfaces.Contains(instance)) return;
                m_Wrapper.m_AbvActionsCallbackInterfaces.Add(instance);
                @v.started += instance.OnV;
                @v.performed += instance.OnV;
                @v.canceled += instance.OnV;
            }

            private void UnregisterCallbacks(IAbvActions instance)
            {
                @v.started -= instance.OnV;
                @v.performed -= instance.OnV;
                @v.canceled -= instance.OnV;
            ...
            public void RemoveCallbacks(IAbvActions instance)
            {
                if (m_Wrapper.m_AbvActionsCallbackInterfaces.Remove(instance))
                    UnregisterCallbacks(instance);
            }

            public void SetCallbacks(IAbvActions instance)
            {
                foreach (var item in m_Wrapper.m_AbvActionsCallbackInterfaces)
                    UnregisterCallbacks(item);
                m_Wrapper.m_AbvActionsCallbackInterfaces.Clear();
                AddCallbacks(instance);
            }
        }
        public AbvActions @abv => new AbvActions(this);
